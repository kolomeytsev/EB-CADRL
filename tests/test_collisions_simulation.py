...
ENV_CONFIG_PATH_1 = (
    "configs/test_configs/test_env_configs/env_adults_5_bikes_5_static_5.config"
)
SCENE_RESULTS_1 = [
...
ENV_CONFIG_PATH_2 = (
    "configs/test_configs/test_env_configs/env_adults_5_bikes_0_static_5.config"
)
SCENE_RESULTS_2 = [
...
ENV_CONFIG_PATH_3 = (
    "configs/test_configs/test_env_configs/env_adults_5_child_5_static_5.config"
)
SCENE_RESULTS_3 = [("collision_with_child.json", CollisionChild)]
...
def run_test_collisions_with_configs(results, env_config, scene_results):
    env, policy, robot = configure_env_policy_robot(
        env_config, POLICY_CONFIG_PATH, policy="linear"
    )
