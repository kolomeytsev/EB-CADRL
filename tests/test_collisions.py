...
import configparser
import numpy as np
from simulator.agents.agents import Adult
...
ENV_CONFIG_PATH = "configs/env_configs/env_adults_5_bikes_5_static_5.config"
...
class TestCollisionAgentWithRobot(unittest.TestCase):
    def test_no_collision_1(self):
        ...
        robot.radius = 1
        adult = Adult(env_config, 'adults')
        adult.set(0, -2, 0, -2, 0, 0, 0)
        adult.radius = 0.9
        ...
        result = compute_collision_agent_with_robot(adult, robot, action, dmin, time_step)
