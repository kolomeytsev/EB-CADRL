...
def run_one_episode(args, phase, policy, imitation_learning, episode):
    try:
        ...
        success = 0
        collision = collision_child = collision_adult = collision_bicycle = collision_obstacle = 0
        timeout = 0
        ...
        assert (success + collision + collision_adult + collision_bicycle + \
        ...
        logging.info('{:<5} {}collision rate adult: {:.2f}, collision rate bicycle: {:.2f},'
                        'collision rate child: {:.2f}, collision rate obstacle: {:.4f}'.
            format(phase.upper(), extra_info, collision_rate_adult, collision_rate_bicycle,
...
class ParallelExplorer(object):
    ...
    def log_val_aggregated(self, results):
        ...
        logging.info('VAL_AGGREGATED collision rate adult: {:.2f}, collision rate bicycle: {:.2f},'
                        'collision rate child: {:.2f}, collision rate obstacle: {:.4f}'.
            format(collision_rate_adult, collision_rate_bicycle,
                   collision_rate_child, collision_rate_obstacle))
