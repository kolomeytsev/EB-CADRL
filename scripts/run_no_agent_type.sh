#!/bin/bash
export ENV_CONFIG="configs/env_configs/adults_8_bikes_8_child_8_static_3_35_sec_new_reward.config"
...
export OUTPUT_DIR="data/adults_8_bikes_8_child_8_static_3_35_sec_new_reward_no_agent_type"
