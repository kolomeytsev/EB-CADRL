#!/bin/bash
export ENV_CONFIG="configs/env_configs/humans_8_bikes_8_child_8_static_3_35_sec_new_reward_ablation.config"
...
export OUTPUT_DIR="data/humans_8_bikes_8_child_8_static_3_35_sec_new_reward_ablation"
